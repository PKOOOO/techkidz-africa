...
const dummyEvents = [
  {
    ...
    description:
      "Connect with leading employers and explore career opportunities in tech. This event brings together top tech companies, startups, and job seekers for networking and career development.",
    isVirtual: false,
    isFeatured: true,
  ...
  },
  {
    ...
    description:
      "A hands-on workshop for women looking to start their journey in technology. Learn coding basics, network with industry professionals, and discover career paths in tech.",
    isVirtual: true,
    isFeatured: false,
  ...
  },
  {
    ...
    location: "Swahilipot Hub, Mombasa",
    description:
      "Young entrepreneurs pitch their ideas to investors and mentors. This is your chance to showcase your startup and get valuable feedback from experienced investors.",
    isVirtual: false,
    isFeatured: true,
  ...
  },
  {
    ...
    location: "Swahilipot Hub, Mombasa",
    description:
      "A comprehensive 3-day bootcamp covering the fundamentals of AI and machine learning. Perfect for developers looking to expand their skills in this rapidly growing field.",
    isVirtual: false,
    isFeatured: true,
  ...
  },
  {
    ...
    location: "Virtual Event",
    description:
      "Learn the latest digital marketing strategies and tools. This masterclass covers social media marketing, SEO, content marketing, and analytics.",
    isVirtual: true,
    isFeatured: false,
  ...
  },
  {
    ...
    location: "Swahilipot Hub, Mombasa",
    description:
      "A full-day summit celebrating youth innovation and entrepreneurship. Featuring keynote speakers, panel discussions, and networking opportunities.",
    isVirtual: false,
    isFeatured: true,
  ...
  },
  {
    ...
    location: "Virtual Event",
    description:
      "Learn modern web development techniques including React, Next.js, and TypeScript. Perfect for beginners and intermediate developers.",
    isVirtual: true,
    isFeatured: false,
  ...
  },
  {
    ...
    location: "Swahilipot Hub, Mombasa",
    description:
      "Monthly community meetup for tech enthusiasts. Share knowledge, network, and discuss the latest trends in technology.",
    isVirtual: false,
    isFeatured: false,
  ...
  },
  {
    ...
    location: "Swahilipot Hub, Mombasa",
    description:
      "48-hour hackathon bringing together developers, designers, and entrepreneurs to build innovative solutions. Prizes and mentorship opportunities available.",
    isVirtual: false,
    isFeatured: true,
  ...
  },
  {
    ...
    location: "Virtual Event",
    description:
      "Introduction to data science using Python and popular libraries. Learn data analysis, visualization, and basic machine learning concepts.",
    isVirtual: true,
    isFeatured: false,
