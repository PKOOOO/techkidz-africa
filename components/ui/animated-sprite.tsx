          ...
          <g id="costume1">
            <g id="costume1.1">
              ...
              <motion.path
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                style={{ transformOrigin: "38px 77px" }}
                animate={{
                  rotate: [15, -15, 15],
                }}
                transition={{
              ...
              <g id="body-main">
                <path
                  d="M 46.2 76.7 C 47.4 75.8 48.6 74.3 50.2 72 C 51.5 70.1 52.9 66.4 52.9 66.4 C 53.8 63.9 54.4 59.1 51.1 59.2 C 48.9 59.3 46.9 59 43.5 58.5 C 37.5 57.3 36.4 56.5 33.9 60.6 C 31.2 65.4 24.3 68.9 32.8 77.2 L 46.2 76.7 Z"
                  id="body-upper"
                  stroke="#001026"
                  strokeWidth="1.2"
                  fill="#FFAB19"
              ...
              <motion.path
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                style={{ transformOrigin: "46px 77px" }}
                animate={{
                  rotate: [-15, 15, -15],
                }}
                transition={{
              ...
              {/* Back arm - walking animation (opposite to leg) */}
              <motion.path
...
// Walking sprite that moves across the container
export function WalkingSprite({ className = "" }: { className?: string }) {
  return (
    <motion.div
      className={className}
      animate={{
    ...
    >
      <AnimatedSprite className="w-full h-full" walkSpeed={0.3} />
    </motion.div>
  );
}
