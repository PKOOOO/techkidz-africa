    ...
    <nav className="sticky top-0 z-50 w-full bg-white/90 backdrop-blur-sm border-b shadow-sm">
      <div className="container-custom flex items-center justify-between h-16 md:h-20">
        ...
        <div className="hidden md:flex md:items-center md:gap-4 lg:gap-6">
          <Link
            href="/"
            className="px-2 py-1 text-foreground hover:text-swahilipot-600 transition-colors"
          >
            Home
          </Link>
          <Link
          ...
          <Button
            className="bg-[#6A1383] hover:bg-[#5a0f70] text-white flex items-center gap-2 ml-2"
            asChild
          >
            <Link href="/events">
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white absolute top-16 w-full border-b shadow-lg">
          <div className="flex flex-col space-y-2 px-4 py-4">
            ...
            <Button
              className="bg-[#6A1383] hover:bg-[#5a0f70] text-white w-full flex items-center justify-center gap-2 mt-2"
              asChild
            >
