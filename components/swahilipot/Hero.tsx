    ...
    <div className="relative overflow-hidden h-[400px] md:h-[500px]">
        ...
        >
          <CarouselContent className="-ml-0 h-full">
            {images.map((image, index) => (
              <CarouselItem
                key={index}
                className="pl-0 basis-full shrink-0 grow-0"
              >
                <div
      ...
      <div className="absolute bottom-0 z-30 inset-x-0 h-24 md:h-32 w-full pointer-events-none">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to top, rgb(245,240,248) 0%, rgb(245,240,248) 5%, rgba(245,240,248,0.98) 10%, rgba(245,240,248,0.9) 20%, rgba(245,240,248,0.75) 35%, rgba(245,240,248,0.5) 55%, rgba(245,240,248,0.25) 75%, rgba(245,240,248,0.1) 90%, transparent 100%)",
      ...
      <div className="container-custom section-padding relative z-10">
        <div className="max-w-3xl mx-auto md:mx-0">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            <Button
              className="w-full sm:w-auto bg-[#6A1383] hover:bg-[#5a0f70] text-white flex items-center justify-center gap-2 text-base"
              asChild
            >
              <Link href="/programs">
            ...
            <Button
              className="w-full sm:w-auto bg-[#38B6FF] hover:bg-[#1A9FE8] text-white flex items-center justify-center gap-2 text-base"
              asChild
            >
