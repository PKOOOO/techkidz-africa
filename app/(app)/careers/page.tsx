...
export const metadata: Metadata = {
  ...
  description:
    "Join the TechKidz Africa team. Explore career opportunities at one of Kenya's leading edtech academies and innovation hubs.",
  alternates: {
        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-700">
              Be part of a passionate team dedicated to empowering youth across
              East Africa.
            </p>
          </div>
        </div>
