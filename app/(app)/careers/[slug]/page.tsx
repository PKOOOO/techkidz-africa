...
export async function generateMetadata({
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `https://techkidzafrica.co.ke/careers/${slug}`,
    },
    openGraph: {
      title,
      description,
          ...
          <div className="space-y-10 w-full max-w-3xl">
            {career.type !== "attachment" && career.description ? (
              <div>
                ...
                <div className="prose max-w-[60ch] text-gray-800 text-base md:text-lg leading-relaxed text-justify">
                  <PortableText
                    value={
                      career.description as Parameters<
                        typeof PortableText
                      >[0]["value"]
                    }
                  />
            ...
            <div className="border-t pt-8">
              ...
              <p className="text-gray-800 text-base md:text-lg leading-relaxed text-justify max-w-[60ch]">
                If there appears to be a fit, we&apos;ll reach out to schedule
                2-3 short technicals. After, we&apos;ll schedule an onsite in
                our office, where you&apos;ll work on a small project, discuss
                ideas, and meet the team.
              </p>
            </div>
          </div>
