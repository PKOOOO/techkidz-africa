...
export const metadata: Metadata = {
  ...
  description:
    "See the measurable impact TechKidz Africa has made in empowering young learners and communities across Kenya through technology education.",
  alternates: {
...
async function getTeamMembers() {
  ...
  return members.map((member: any) => ({
    ...
    imageUrl: member.image
      ? urlFor(member.image).width(800).height(800).url()
...
export default async function ImpactPage() {
  ...
  return (
    <>
      ...
      {/* Title overlapping blur, above the stats */}
