...
export const metadata: Metadata = {
  ...
  description:
    "Explore TechKidz Africa's technology programs designed to empower learners with hands-on digital, coding, and innovation skills.",
  alternates: {
      ...
      <section className="section-padding bg-swahilipot-900">
        <div className="container-custom text-center">
          ...
          <p className="text-swahilipot-200 mb-8 max-w-xl mx-auto">
            Join our programs and take the first step towards building your
            future.
          </p>
          <Button
            className="bg-white text-swahilipot-900 hover:bg-swahilipot-100"
            asChild
          >
